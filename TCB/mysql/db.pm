...
TCB::mysql::db - authentication information for MySQL, by database
...
The 'db' table describes what databases can be affected by which users
and/or hosts, and in what ways they can be affected.  Its siblings are 
the 'host' and 'user' tables.
...
Key fields:     Host, Db, User

List items:     Host, Db, User
...
<div class="basetable">
 ...
 <div class="row2">
  ...
  <span class="formw">
   <input type="text" name="User" value="@{[ $$entry{User} || ""]}" size="18" maxlength="255" />
  </span>
 </div>
